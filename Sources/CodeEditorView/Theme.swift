...
public struct Theme: Identifiable {
    ...
    /// The name of the code font to use.
    ///
    public var codeFontName: String {
        didSet { id = UUID() }
    }
    
    /// The point size of the code font to use.
    ///
    ...
    public init(
        ...
        codeFontName: String = Theme.defaultDark.codeFontName,
        codeFontSize: CGFloat = Theme.defaultDark.codeFontSize,
...
extension Theme {
    ...
    public static var defaultDarkMarkdown: Theme
    = Theme(colourScheme: .dark,
            fontName: "SFPro-Regular",
            fontSize: 14.0,
            codeFontName: "SFMono-Medium",
            codeFontSize: 13.0,
            textColour: OSColor(red: 0.9, green: 0.9, blue: 0.9, alpha: 0.9),
            commentColour: OSColor(red: 0.51, green: 0.55, blue: 0.59, alpha: 0.9),
            stringColour: OSColor(red: 0.94, green: 0.53, blue: 0.46, alpha: 0.9),
            characterColour: OSColor(red: 0.84, green: 0.79, blue: 0.53, alpha: 0.9),
            numberColour: OSColor(red: 0.81, green: 0.74, blue: 0.40, alpha: 0.9),
            
            /// Dave: This is (currently) the green, main colour
            identifierColour: OSColor(red: 0.41, green: 0.72, blue: 0.64, alpha: 0.2),
            operatorColour: OSColor(red: 0.62, green: 0.94, blue: 0.87, alpha: 0.9),
            keywordColour: OSColor(red: 0.94, green: 0.51, blue: 0.69, alpha: 0.9),
            symbolColour: OSColor(red: 0.72, green: 0.72, blue: 0.73, alpha: 0.9),
            typeColour: OSColor(red: 0.36, green: 0.85, blue: 1.0, alpha: 0.9),
            fieldColour: OSColor(red: 0.63, green: 0.40, blue: 0.90, alpha: 0.9),
            caseColour: OSColor(red: 0.82, green: 0.66, blue: 1.0, alpha: 0.9),
            backgroundColour: OSColor(red: 0.16, green: 0.16, blue: 0.18, alpha: 0.0),
            currentLineColour: OSColor(red: 0.19, green: 0.20, blue: 0.22, alpha: 0.2),
            selectionColour: OSColor(red: 0.40, green: 0.44, blue: 0.51, alpha: 0.8),
            cursorColour: OSColor(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0),
            invisiblesColour: OSColor(red: 0.33, green: 0.37, blue: 0.42, alpha: 1.0))
