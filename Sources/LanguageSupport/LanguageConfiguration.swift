...
public struct LanguageConfiguration {
    ...
    /// Dave: I've learned this means: a single regular expression that
    /// defines how strings are recognised, in this language.
    /// Not, here is a place you can define a variety of string-based regex's
    ...
    /// Dave: An identifier is a name that is assigned by the user for a program element
